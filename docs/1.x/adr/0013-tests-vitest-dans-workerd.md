# ADR-0013 : Tests — Vitest dans `workerd`, Playwright pour les parcours, épreuve de réversibilité scriptée
Statut : Accepté | Date : 2026-08-13 | Trace vers : [docs/stack.md](../stack.md) — candidat n° 13, ligne « Tests »

## Contexte

Le [Brief](../brief.md) pose que « le code entrant n'est pas relu ligne à ligne » : la confiance

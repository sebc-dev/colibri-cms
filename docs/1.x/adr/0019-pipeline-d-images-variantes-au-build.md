# ADR-0019 : Pipeline d'images — les variantes sont produites au build
Statut : Accepté | Date : 2026-08-13 | Trace vers : [docs/stack.md](../stack.md) — candidat n° 19, ligne « Pipeline d'images »
...
([ADR-0011](./0011-ilots-svelte-5.md)). Il faut donc plusieurs variantes par image, et le lieu
...
- le budget de sous-requêtes d'une publication borne les médias à **42**
  ([ADR-0005](./0005-forge-github-api-git-data-jeton-a-portee-fine.md)), et ce budget compte

# ADR-0022 : `src/core/` n'importe ni framework ni plateforme
Statut : Accepté | Date : 2026-08-13 | Trace vers : [docs/archi.md](../archi.md) — invariant `I2`
...
- Les deux calculs exacts du PRD se testent **sans base, sans HTTP et sans Worker** — donc vite,
  ...
  ([ADR-0013](./0013-tests-vitest-dans-workerd.md)).

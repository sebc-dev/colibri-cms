# ADR-0009 : Acheminement des demandes — Email Routing et `send_email` vers l'adresse de destination vérifiée, e-mail inerte et étiqueté
Statut : Accepté | Date : 2026-08-13 | Trace vers : [docs/stack.md](../stack.md) — candidat n° 9, ligne « Acheminement des demandes »
...
([ADR-0006](./0006-auth-implementation-maison-sur-d1.md)), et le formulaire de devis est ouvert

# ADR-0001 : Cible de déploiement et système de build — un Worker Cloudflare unique bâti par Workers Builds
Statut : Accepté | Date : 2026-08-13 | Trace vers : [docs/stack.md](../stack.md) — candidat n° 1, lignes « Cible de déploiement et système de build » et « Déclenchement du build »

# ADR-0029 : Les préfixes que la publication a le droit d'écrire sont déclarés dans une constante unique, et `.github/` n'y figure pas
Statut : Accepté | Date : 2026-08-13 | Trace vers : [docs/archi.md](../archi.md) — invariant `I9`

## Contexte

[ADR-0005](./0005-forge-github-api-git-data-jeton-a-portee-fine.md) a retenu un jeton à portée
...
- **La contrainte silencieuse de [ADR-0005](./0005-forge-github-api-git-data-jeton-a-portee-fine.md)
...
- La liste vit dans `src/core/`, donc **la décision de ce qui est écrit est du métier**, et
  ...
  [ADR-0021](./0021-sens-descendant-des-dependances-entre-zones.md) et
  [ADR-0022](./0022-core-sans-framework-ni-plateforme.md).

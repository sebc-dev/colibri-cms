...
Statut : Candidat | Date : 2026-08-23 | Provenance : `docs/1.x/adr/0014-ingestion-des-medias-liste-blanche-sur-octets.md` (ADR-0014 accepté sous le cycle 1.x)
...
([ADR-0004](../../1.x/adr/0004-medias-deux-magasins-un-par-etat.md)). Le volet **format** est ouvert, et
...
([ADR-0001](../../1.x/adr/0001-cible-de-deploiement-worker-unique-workers-builds.md)), avec un
...
- `X-Content-Type-Options: nosniff`, posé par ailleurs
  ([ADR-0015](../../1.x/adr/0015-en-tetes-de-reponse-deux-porteurs.md)), rattrape le résidu : un fichier
...
- **Le SVG assaini** : écartée — c'est le motif de
  [ADR-0008](../../1.x/adr/0008-texte-riche-markdown-restreint.md) dans l'autre sens. Un SVG est un document

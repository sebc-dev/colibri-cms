...
Oui — job `test` : l'aller-retour de sérialisation Markdown et le rejet d'une URL de schéma non autorisé. Épreuves **à écrire** ; seule ligne du registre de `docs/ci.md` déclarée **bloquante**.

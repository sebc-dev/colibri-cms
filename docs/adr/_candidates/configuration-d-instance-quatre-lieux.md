# Candidat ADR : Configuration d'instance — quatre lieux, un par nature de valeur, et un fichier d'instance unique pour le reste
Statut : Candidat | Date : 2026-08-23 | Provenance : `docs/1.x/adr/0020-configuration-d-instance-quatre-lieux.md` (ADR-0020 accepté sous le cycle 1.x)

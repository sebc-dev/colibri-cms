# Candidat ADR : En-têtes de réponse — deux porteurs imposés par la plateforme, CSP stricte de l'administration, origine commune conservée
Statut : Candidat | Date : 2026-08-23 | Provenance : `docs/1.x/adr/0015-en-tetes-de-reponse-deux-porteurs.md` (ADR-0015 accepté sous le cycle 1.x)

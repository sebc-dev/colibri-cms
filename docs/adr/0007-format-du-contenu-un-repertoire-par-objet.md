# ADR-0007 : Format du contenu déposé — un répertoire par objet
Statut : Accepté | Date : 2026-08-13 | Trace vers : [docs/stack.md](../stack.md) — candidat n° 7, ligne « Contenu publié en fichiers »
...
- Le coût d'appel de la publication n'en dépend pas : le contenu textuel est inliné dans
  ...
  [ADR-0005](./0005-forge-github-api-git-data-jeton-a-portee-fine.md).

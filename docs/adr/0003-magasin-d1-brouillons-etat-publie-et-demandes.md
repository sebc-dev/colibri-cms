# ADR-0003 : Magasin — D1 porte les brouillons, l'état publié et les demandes ; le dépôt reçoit la copie publiée
Statut : Accepté | Date : 2026-08-13 | Trace vers : [docs/stack.md](../stack.md) — candidat n° 3, ligne « Base de données »

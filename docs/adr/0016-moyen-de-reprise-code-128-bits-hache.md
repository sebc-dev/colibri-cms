# ADR-0016 : Moyen de reprise — un code de 128 bits haché en D1, remis sur papier, à usage unique et réémis à l'emploi
Statut : Accepté | Date : 2026-08-13 | Trace vers : [docs/stack.md](../stack.md) — candidat n° 16, ligne « Moyen de reprise »
...
Le contexte d'entropie vient de [ADR-0006](./0006-auth-implementation-maison-sur-d1.md) : le
...
- **La rémanence de session longue** : écartée par `A-02` au motif qu'elle est irrévocable en cas
  ...
  [ADR-0006](./0006-auth-implementation-maison-sur-d1.md), mais une session n'est pas un secret

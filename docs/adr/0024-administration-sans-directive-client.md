# ADR-0024 : Aucun gabarit de `src/admin/` ne porte de directive `client:*`
Statut : Accepté | Date : 2026-08-13 | Trace vers : [docs/archi.md](../archi.md) — invariant `I4`

## Contexte

[ADR-0015](./0015-en-tetes-de-reponse-deux-porteurs.md) a retenu une **CSP stricte propre à
...
([ADR-0011](./0011-ilots-svelte-5.md)). Il faudrait donc un nonce à chaque réponse — et Astro ne
sait pas en poser.

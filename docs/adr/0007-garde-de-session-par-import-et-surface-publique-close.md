...
Promu depuis `docs/legacy/1.x/adr/0026-garde-de-session-par-import-et-surface-publique-close.md` — ADR-0026, accepté sous le cycle 1.x.
...
- **Le périmètre est lié à `run_worker_first`.** Ajouter un troisième préfixe servi par le code
  ...
  [ADR-0015](../legacy/1.x/adr/0015-en-tetes-de-reponse-deux-porteurs.md) doit garder cette liste bornée.
- **La route d'aperçu doit vivre sous `src/pages/admin/`** — conséquence déjà portée par
  [ADR-0023](../legacy/1.x/adr/0023-rendu-partage-par-le-publie-et-l-apercu.md).

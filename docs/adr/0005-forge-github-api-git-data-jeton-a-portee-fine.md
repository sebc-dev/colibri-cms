# ADR-0005 : Forge et écriture de la publication — GitHub, API REST *git data*, avance rapide obligatoire, jeton à portée fine à une seule permission
Statut : Accepté | Date : 2026-08-13 | Trace vers : [docs/stack.md](../stack.md) — candidat n° 5, lignes « Forge et écriture de la publication » et « Maintien en vie du jeton d'écriture »
...
- **La publication n'écrit jamais sous `.github/`.** C'est la condition sous laquelle
  ...
  **dernier** geste de la publication — celui qui rend le contenu visible — et **rien dans le
  ...
  l'invariant `I9` de [`docs/archi.md`](../archi.md).

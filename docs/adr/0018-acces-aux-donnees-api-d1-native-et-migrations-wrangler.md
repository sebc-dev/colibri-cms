# ADR-0018 : Accès aux données — l'API D1 native du Worker et les migrations `wrangler d1 migrations`, sans couche intermédiaire
Statut : Accepté | Date : 2026-08-13 | Trace vers : [docs/stack.md](../stack.md) — candidat n° 18, ligne « Accès aux données »
...
Le magasin est acquis ([ADR-0003](./0003-magasin-d1-brouillons-etat-publie-et-demandes.md)), et
...
- **Pas de requêtes typées, ni de schéma décrit en un seul endroit.** TypeScript strict
  ([ADR-0010](./0010-langage-typescript-strict.md)) en couvre une part — pas tout : le lien
...
- **Kysely** : écartée car il n'atteint D1 que par un dialecte **tiers**, `kysely-d1@0.4.0`,
  ...
  [ADR-0006](./0006-auth-implementation-maison-sur-d1.md) — et cette fois sur le chemin d'accès

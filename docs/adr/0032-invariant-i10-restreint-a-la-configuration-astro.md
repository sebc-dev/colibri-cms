# ADR-0032 : L'invariant `I10` ne porte que la configuration Astro — la configuration du déploiement en sort
Statut : Accepté | Date : 2026-08-15 | Trace vers : [docs/archi.md](../archi.md) — invariant `I10` · remplace [ADR-0030](./0030-configurations-lisent-le-fichier-d-instance.md)

## Contexte

[ADR-0030](./0030-configurations-lisent-le-fichier-d-instance.md) (accepté le 2026-08-13) exige
...
[ADR-0020](./0020-configuration-d-instance-quatre-lieux.md) affecte les **liaisons de plateforme**
...
([ADR-0020](./0020-configuration-d-instance-quatre-lieux.md)) — `database_id` compris, à la
livraison réelle.
...
- **Plus rien ne dit d'où vient une valeur de la configuration du déploiement.** Le jour où une
  ...
  [ADR-0020](./0020-configuration-d-instance-quatre-lieux.md) a donné à chaque nature de valeur

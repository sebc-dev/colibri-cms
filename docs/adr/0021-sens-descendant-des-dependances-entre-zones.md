# ADR-0021 : Le sens des dépendances entre zones est unique et descendant
Statut : Accepté | Date : 2026-08-13 | Trace vers : [docs/archi.md](../archi.md) — invariant `I1`

## Contexte

[ADR-0001](./0001-cible-de-deploiement-worker-unique-workers-builds.md) a retenu **un artefact
...
routage imposée par Astro ([ADR-0002](./0002-generateur-astro-7.md)).
...
- **Tenir la frontière par le déploiement** (deux artefacts, l'un public l'autre
  d'administration) : écartée par [ADR-0001](./0001-cible-de-deploiement-worker-unique-workers-builds.md)
...
- **Ne poser aucune règle de sens et s'en remettre à la convention à la relecture** : écartée car
  le [Brief](../brief.md) pose que « le code entrant n'est pas relu ligne à ligne ». Une
...
- **Des zones sans matrice, avec pour seul interdit l'isolement de `core/`** : écartée car moins
  ...
  ([ADR-0002](./0002-generateur-astro-7.md)), du code d'administration partirait dans le

# ADR-0025 : Le HTML brut n'est rendu qu'en un seul lieu — `src/render/markdown/`
Statut : Accepté | Date : 2026-08-13 | Trace vers : [docs/archi.md](../archi.md) — invariant `I5`

## Contexte

Le site public et l'administration partagent une **origine commune**
([ADR-0001](./0001-cible-de-deploiement-worker-unique-workers-builds.md)) : tout contenu tiers
...
- **Le seul lieu autorisé ne rend que du Markdown restreint**, déjà filtré sur ses marques et
  ses schémas d'URL ([ADR-0008](./0008-texte-riche-markdown-restreint.md)) : l'exception est
...
- **Un besoin de rendu riche non couvert par le Markdown restreint n'a pas d'échappatoire** : il
  ...
  [ADR-0008](./0008-texte-riche-markdown-restreint.md), ou de remplacer cet ADR-ci.
...
- **Autoriser `{@html}` partout et s'en remettre à l'assainissement** : écartée — c'est le motif
  de [ADR-0008](./0008-texte-riche-markdown-restreint.md), un assainissement raté est un risque

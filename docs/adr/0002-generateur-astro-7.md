# ADR-0002 : Générateur du site public et de l'aperçu — Astro 7
Statut : Accepté | Date : 2026-08-13 | Trace vers : [docs/stack.md](../stack.md) — candidat n° 2, ligne « Générateur du site public et de l'aperçu »
...
Servis par ailleurs : `SC-005`. Le choix est contraint par [ADR-0001](./0001-cible-de-deploiement-worker-unique-workers-builds.md),
...
- La configuration d'images d'Astro décide, au-delà d'elle-même, du **plafond de médias du
  produit** — voir [ADR-0019](./0019-pipeline-d-images-variantes-au-build.md).

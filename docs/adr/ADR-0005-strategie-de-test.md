...
- **INTERDIT** : envoyer un vrai e-mail en test (mailer mocké — garde-fou free-tier). *(Amendement 2026-08-01 : le mailer par défaut est **Cloudflare Email Service**, cf. ADR-0007 amendement (b) — après un aller-retour par Resend le même jour. La règle est inchangée : seul le fournisseur mocké change, ce qui est exactement ce que le seam `sendMail` garantit.)*

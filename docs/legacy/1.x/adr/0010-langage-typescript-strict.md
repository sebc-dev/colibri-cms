# ADR-0010 : Langage — TypeScript en mode strict
Statut : Accepté | Date : 2026-08-13 | Trace vers : [docs/stack.md](../stack.md) — candidat n° 10, ligne « Langage »

## Contexte

Le [Brief](../brief.md) pose que « le code entrant n'est pas relu ligne à ligne » et que la
confiance doit venir de **vérifications mécaniques**. C'est la même exigence qui fonde la
caractéristique architecturale `C5` de [`docs/archi.md`](../archi.md) — testabilité sans

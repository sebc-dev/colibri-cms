# ADR-0014 : Ingestion des médias — liste blanche fermée JPEG / PNG / WebP, reconnue sur les octets d'en-tête, SVG refusé
Statut : Accepté | Date : 2026-08-13 | Trace vers : [docs/stack.md](../stack.md) — candidat n° 14, ligne « Ingestion des médias »
...
([ADR-0004](./0004-medias-deux-magasins-un-par-etat.md)). Le volet **format** est ouvert, et
...
([ADR-0001](./0001-cible-de-deploiement-worker-unique-workers-builds.md)), avec un
...
- `X-Content-Type-Options: nosniff`, posé par ailleurs
  ([ADR-0015](./0015-en-tetes-de-reponse-deux-porteurs.md)), rattrape le résidu : un fichier
...
- **Le SVG assaini** : écartée — c'est le motif de
  [ADR-0008](./0008-texte-riche-markdown-restreint.md) dans l'autre sens. Un SVG est un document
...
- **Le SVG servi depuis une origine distincte** : écartée car elle ferme le vol de session, mais
  ...
  [socle de livraison](../socle-de-livraison.md), pour un format dont le produit n'a pas besoin.

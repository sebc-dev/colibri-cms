# ADR-0026 : Le garde de session est tenu par l'import, et la surface publique est close
Statut : Accepté | Date : 2026-08-13 | Trace vers : [docs/archi.md](../archi.md) — invariant `I6`
...
- **Le périmètre est lié à `run_worker_first`.** Ajouter un troisième préfixe servi par le code
  ...
  [ADR-0015](./0015-en-tetes-de-reponse-deux-porteurs.md) doit garder cette liste bornée.
- **La route d'aperçu doit vivre sous `src/pages/admin/`** — conséquence déjà portée par
  [ADR-0023](./0023-rendu-partage-par-le-publie-et-l-apercu.md).

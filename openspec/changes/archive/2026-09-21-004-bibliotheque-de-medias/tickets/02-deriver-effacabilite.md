...
**Bloqué par :** —
**Vérif :** tdd
**Fichiers :** `src/core/medias/references.ts` (nouveau — dérivation pure), `tests/static/`
...
## Critères
- [x] Une image qu'au moins un emplacement — publié ou brouillon — référence n'est pas effaçable.   (SC-02a)
- [x] Une image qu'aucun emplacement, ni publié ni brouillon, ne référence est effaçable.   (SC-02b)

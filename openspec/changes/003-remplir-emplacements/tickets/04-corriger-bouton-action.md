...
- [ ] La table D1 des brouillons est créée par une migration versionnée (`wrangler d1 migrations`, ADR d'accès aux données), et lie le brouillon à l'emplacement déclaré par son identité stable.   (SC-04d)

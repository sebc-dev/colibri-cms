...
## Critères
- [ ] Une déclaration de page portant des emplacements de nature image, galerie ou carrousel est lue : chacun est reconnu selon sa nature avec son contenu courant — les identités des images référencées —, une entrée mal formée étant écartée comme pour les autres natures.   (SC-03a)
- [ ] Une pose qui viserait un emplacement non déclaré, ou un emplacement d'une nature autre qu'image, galerie ou carrousel, est refusée sans qu'aucun brouillon ne soit écrit.   (SC-03b)

...
## Critères
- [x] Les emplacements paraissent dans l'ordre posé, chacun présenté selon sa nature — texte riche, lien de vidéo, bouton d'action, image, galerie, carrousel — le moyen d'édition de chaque nature d'image venant avec sa pose.   (SC-06a)
- [x] Chaque emplacement d'image, de galerie ou de carrousel montre son contenu courant.   (SC-06b)
- [x] Aucun geste n'ajoute, ne retire, ne déplace ni ne renomme un emplacement, et rien ne l'offre à l'écran.   (SC-06c)
- [x] Aucun terme de développeur ne paraît dans l'éditeur.   (SC-06d)
